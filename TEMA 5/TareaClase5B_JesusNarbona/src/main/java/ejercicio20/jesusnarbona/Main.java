...
public class Main {
    public static void main(String[] args) {
        ...
        cineEstepona.removePelicula(new Peliculas("Moonfall","Español","Roland Emmerich",""));
        System.out.println("\nPELICULAS CINE ESTEPONA [Total: "+cineEstepona.numeroPeliculas()+"]");
        cineEstepona.imprimirPeliculas();

        cineEstepona.modificar(new Peliculas("Spiderman no way home", "Frances", "Jon Watts", ""),
                new Peliculas("A", "A", "A", "A"));
        System.out.println("\nCambio de pelicula de spiderman:");
        cineEstepona.imprimirPeliculas();
