...
public class Main {
    public static void main(String[] args) {
        ...
        spotify.ordenarNombre();
        System.out.println(spotify.buscarCancionNombre(new Cancion("Melendrill",0,"",0)));

        spotify.ordenarNombreMinutos();
        System.out.println(spotify.buscarCancionNombreMinutos(new Cancion("Melendrill",2,"",0)));
