 ...
 * @author jesus
 */
public class Ej05SeleccionMejoradoString {
        ...
        do{
            ...
            opcion = entrada.nextLine();
                ...
                case "1":
                    ...
                    System.out.printf("El area del cuadrado de lado [%.2f] es de: %.2f\n\n", ladoCuadrado, areaCuadrado);
                ...
                case "2":
                    ...
                    System.out.printf("El area del triangulo de base [%.2f] y altura [%.2f] es de: %.2f\n\n", baseTriangulo, alturaTriangulo, areaTriangulo);
                ...
                case "3":
                    ...
                    System.out.printf("El area del circulo de radio [%.2f] es de: %.2f\n\n", radioCirculo, areaCirculo);
