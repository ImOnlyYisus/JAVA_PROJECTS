...
import gui.jesus.crud.usuario.CreateUser;
import gui.jesus.crud.usuario.DeleteUser;
import gui.jesus.crud.usuario.UpdateUser;
...
public class Usuarios extends javax.swing.JPanel {
    ...
    public Usuarios() {
        ...
        List<Usuario> usuarios = controladorUsuario.findAll();
        usuarios.forEach(usuario -> {
        	table.addRow(new Object[]{usuario.getEmail(),
        			usuario.getContraseña(),
        			usuario.getUltModPasswd()!=null ? usuario.getUltModPasswd() : "null" ,
        			usuario.getUltConexion()!=null ? usuario.getUltConexion() : "null" ,
        			usuario.getKeyUser(),
        			usuario.getCuenta().getId()});
        });        
    }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Email", "Contraseña", "Ult. mod. contraseña", "Ult. conexion", "Key", "Id Cuenta"
            }
        ) {
