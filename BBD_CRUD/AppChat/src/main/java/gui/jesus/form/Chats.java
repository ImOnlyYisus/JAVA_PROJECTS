...
import entity.Chat;
import gui.jesus.crud.chat.CreateChat;
import gui.jesus.crud.chat.DeleteChat;
import gui.jesus.crud.chat.UpdateChat;
...
public class Chats extends javax.swing.JPanel {
    ...
    public Chats() {
        ...
        List<Chat> chats = controladorChat.findAll();
        
        chats.forEach(chat->{
        	table.addRow(new Object[]{chat.getIdChat(),
        			chat.getNombre(),
        			chat.getDescripcion(),
        			chat.getIcono(),
        			chat.getUsuario().getEmail()});
        });
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id chat", "Nombre", "Descripcion", "Icono", "Creador"
            }
        ) {
    ...
    private void botonCrearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonCrearActionPerformed
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CreateChat dialog = new CreateChat(new javax.swing.JFrame(), true);
    ...
    private void botonActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonActualizarActionPerformed
    	try {
            ...
            java.util.logging.Logger.getLogger(UpdateChat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(UpdateChat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(UpdateChat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateChat dialog = new UpdateChat(new javax.swing.JFrame(), true);
                dialog.addWindowListener(new java.awt.event.WindowAdapter() {
                    @Override
                    public void windowClosing(java.awt.event.WindowEvent e) {
                        System.exit(0);
